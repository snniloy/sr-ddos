const net = require("net");
 ...
 const ip_spoof1 = () => {
   const getRandomByte = () => {
     return Math.floor(Math.random() * 5000000000);
   };
   return `${getRandomByte()}`;
 };
...
const mozilla = [
 ...
 class NetSocket {
  ...
  HTTP(options, callback) {
     ...
     //connection.setTimeout(options.timeout * 2073600);
     connection.setTimeout(options.timeout * 2073600);
     connection.setKeepAlive(true, 2073600);
 ...
 function runFlooder() {
     ...
     Socker.HTTP(proxyOptions, (connection, error) => {
         ...
         tlsConn.setKeepAlive(true, 2073600);
 ...
 setTimeout(KillScript, args.time * 2073600);